...
import re
import pandas as pd
from mappings import TARGET_DATASET_MAP
...
INPUT_ROOT_DIR = 'phase3_results'
OUTPUT_ROOT_DIR = 'parsed_phase3_results'
...
def process_all_files_with_lora(target_model_key=None, clarify: bool = False, lora_dir: str = "/storage3-ciber/parush/lora"):
    """
    ...
    for dirpath, dirnames, filenames in os.walk(INPUT_ROOT_DIR):
        ...
        for target, target_files in files_by_target.items():
            ...
            if os.path.exists(adapter_path):
                ...
                llm_client = LLMClient(model_key, cache_dir='/storage3-ciber/parush', adapter_path=adapter_path)
            else:
