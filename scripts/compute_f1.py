"""Compute macro-F1 from parsed predictions for both phases (base + LoRA)."""
...
PARSED_PHASE1_DIR = str(REPO_ROOT / "results" / "parsed_phase1_results")
PARSED_PHASE3_DIR = str(REPO_ROOT / "results" / "parsed_phase3_results")
OUTPUT_DIR = str(REPO_ROOT / "results" / "f1_scores")
