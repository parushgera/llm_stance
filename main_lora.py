...
from mappings import TARGETS_MAP, TARGET_MODULES_MAP, TARGET_DATASET_MAP
from in_target_prompts_v2 import chat_manager, SYSTEM_INSTRUCTION
#ALL_TARGET_KEYS = list(TARGETS_MAP.keys())
ALL_TARGET_KEYS = ['ent', 'hlt', 'bernie', 'joe', 'dtp', 'dt', 'la', 'cc', 'fm', 'hc', 'at', 'face', 'fauci', 'school', 'stay']
warnings.filterwarnings("ignore")
# Set up logging
log_dir = "/storage3-ciber/parush/lora/logs"
...
for model_key, model_name in models_to_train.items():
    ...
    for target_key in ALL_TARGET_KEYS:
        ...
        output_dir = f"/storage3-ciber/parush/lora/{model_key}/{target_key}"
...
Stance:"""
        ...
        tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir="/storage3-ciber/parush")
